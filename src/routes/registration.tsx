        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            <p className="font-sans text-lg text-white/70 max-w-2xl mx-auto font-light">
              Register your interest to join the Power & Energy Society at Kongu Engineering
              College.
            </p>
          </motion.div>
        </div>
              ...
              {isSubmitted ? (
                ...
                >
                  ...
                  <p className="text-muted-foreground font-sans mb-8">
                    Thank you for expressing interest in joining IEEE PES KEC. Our team will contact
                  ...
                  >
                    {currentStep === 1 && (
                      ...
                      >
                        ...
                        <div>
                          <label htmlFor="dob" className="block text-sm font-medium text-navy">
                            Date of Birth
                          </label>
                          <input
                            type="date"
                        ...
                        <div>
                          ...
                          <select
                            ...
                            name="gender"
                            required
                            className="mt-1 block w-full border border-border bg-background py-2.5 px-3 text-foreground focus:border-kec focus:outline-none focus:ring-1 focus:ring-kec"
                          >
                      ...
                      >
                        <div>
                          ...
                          <input
                            ...
                            name="rollNumber"
                            id="rollNumber"
                            placeholder="e.g. 24EER001"
                            required
                            className="mt-1 block w-full border border-border bg-background py-2 px-3 text-foreground focus:border-kec focus:outline-none focus:ring-1 focus:ring-kec"
                          />
                        </div>
                        <div>
                          <label htmlFor="year" className="block text-sm font-medium text-navy">
                            Year of Study
                          </label>
                          <select
                            id="year"
                        ...
                        <div className="sm:col-span-2">
                          ...
                          <input
                            ...
                            name="department"
                            id="department"
                            defaultValue="Electrical and Electronics Engineering"
                            required
                            className="mt-1 block w-full border border-border bg-background py-2 px-3 text-foreground focus:border-kec focus:outline-none focus:ring-1 focus:ring-kec"
                          />
                        </div>
                        ...
                        <div className="sm:col-span-2">
                          <label htmlFor="ieeeMember" className="flex items-center mt-2">
                            <input
                              ...
                              name="ieeeMember"
                              type="checkbox"
                              className="h-4 w-4 border-border text-ieee focus:ring-ieee rounded-sm"
                            />
                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          currentStep === 1
                            ...
                            : "text-navy hover:bg-background border border-border",
                        )}
                      >
                        Back
                      </button>
